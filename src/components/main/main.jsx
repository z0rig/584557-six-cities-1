...
import {getCurrentCityOffers, getCurrentCity} from "../../reducer/offers/selectors";

const Main = (props) => {
  const {offersQuantity, currentCity} = props;
        ...
        <div className="cities__places-wrapper">
          <div className="cities__places-container container">
            <section className="cities__places places">
              ...
              <b className="places__found">{offersQuantity} places to stay in {currentCity}</b>
...
const mapStateToProps = (state) => {
  return {
    ...
    offersQuantity: getCurrentCityOffers(state).length
  };
};
